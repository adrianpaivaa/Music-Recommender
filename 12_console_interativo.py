...
# --- CONFIGURAÇÃO ---
# Use 50 ou 100 arquivos para ter uma base boa de busca
...
print(f"--- SISTEMA DE RECOMENDAÇÃO INTERATIVO (SPOTIFY GRAPH) ---")
print("Carregando dados e montando grafo... (Isso pode levar alguns segundos)")
    ...
    with open(os.path.join(pasta_dados, nome_arq), 'r') as f:
        ...
        for pl in data['playlists']:
            ...
            for track in pl['tracks']:
                ...
                # Usamos lower() para busca insensível a maiúsculas
...
while True:
    ...
    if not resultados:
        print("❌ Música não encontrada na base carregada. Tente outra.")
        continue
